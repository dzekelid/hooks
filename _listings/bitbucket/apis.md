...
- name: Bitbucket Parameters Repositories Username Repo Slug Hooks
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/hooks/master/_listings/bitbucket/repositories-username-repo-slug-hooks-parameters.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/hooks/master/_listings/bitbucket/repositories-username-repo-slug-hooks-parameters-postman.md
x-common:
- type: x-developer
