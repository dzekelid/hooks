...
- name: Bitbucket Parameters Repositories Username Repo Slug Hooks U
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/hooks/master/_listings/bitbucket/repositories-username-repo-slug-hooks-uid-parameters.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/hooks/master/_listings/bitbucket/repositories-username-repo-slug-hooks-uid-parameters-postman.md
x-common:
- type: x-developer
